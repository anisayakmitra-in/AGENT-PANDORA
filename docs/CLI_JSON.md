...
| `pandora evaluation regression ... --json` | `evaluation regression` | propose/inspect/review: `id`, `case_id`, `source_execution_id`, `target`, `task`, `failure_digest`, `status`, `review_required_before_suite`, `durability`; list: `candidates`, `count`, `durability`
