...
- register and schedule task-backed prompt, Skill, workflow, and WebAssembly Gene evaluations; the current registry executes validated suite-bound golden inputs;
