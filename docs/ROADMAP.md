...
- retain clean-machine desktop install, start, update, rollback, and uninstall
  evidence on every advertised platform;
- complete native screen-reader and clean-machine scaling checks;
