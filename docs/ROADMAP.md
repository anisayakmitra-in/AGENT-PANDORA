...
- typed target bindings and bounded task labels now register with prompt, Skill, workflow, and WebAssembly Gene cases; the current runner still evaluates redacted suite-bound evidence and does not execute those tasks;
