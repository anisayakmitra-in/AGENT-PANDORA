...
Status: Beta in the current `2.0.0-beta.3` CLI release line.
...
```text
pandora fleet register node-a --version 2.0.0-beta.3 --worker-class local --capabilities-json '["coding","review"]'
