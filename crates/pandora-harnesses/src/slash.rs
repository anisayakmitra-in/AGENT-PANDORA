...
fn built_in_gene_alias(id: &str) -> Option<&'static str> {
    match id {
        ...
        "operations.inventory" => Some("/operations-inventory"),
        "operations.search" => Some("/operations-search"),
        "config.inspect" => Some("/config-inspect"),
        ...
        "security.triage" => Some("/security-triage"),
        "security.attack-path" => Some("/security-attack-path"),
        "security.validation" => Some("/security-validation"),
        "security.fix" => Some("/security-fix"),
        "security.verify-fix" => Some("/security-verify-fix"),
        "security.writeup" => Some("/security-writeup"),
        "security.track" => Some("/security-track"),
        ...
        "data.inventory" => Some("/data-inventory"),
        "data.schema" => Some("/data-schema"),
        "data.quality" => Some("/data-quality"),
        "data.lineage" => Some("/data-lineage"),
        "data.analysis" => Some("/data-analysis"),
        "data.guide" => Some("/data-guide"),
        _ => None,
    }
}
