...
pub use memory::{
    MAX_MEMORY_SYNTHESIS_EVIDENCE, MEMORY_CONSOLIDATION_POLICY_VERSION, MemoryApproval,
    MemoryAuditAction, MemoryAuditEntry, MemoryConflictRule, MemoryConsolidationBoundary,
    MemoryConsolidationPolicy, MemoryContractError, MemoryKind, MemoryOrigin, MemoryRecord,
...
pub use package::{
    ...
    MAX_DOMAIN_ROUTE_HINTS, MAX_GENE_CAPABILITIES, PACKAGE_LOCK_FORMAT_VERSION,
    PackageCompatibility, PackageDependency, PackageKind, PackageLock, PackageLockError,
    PackageManifest, PackageManifestError, TrustEvidence, TrustLevel, hash_artifact,
};
pub use population::{
