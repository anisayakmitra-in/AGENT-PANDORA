...
impl ContainmentControl {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ProcessTreeTermination => "process_tree_termination",
            ...
            Self::DnsResolutionPinning => "dns_resolution_pinning",
            Self::RedirectsDisabled => "redirects_disabled",
            Self::TextMediaOnly => "text_media_only",
...
impl ContainmentLimitation {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::HostNetworkNotSandboxed => "host_network_not_sandboxed",
