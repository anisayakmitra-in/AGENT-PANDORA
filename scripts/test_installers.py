...
class InstallerContractTests(unittest.TestCase):
    ...
    def test_release_url_requires_https(self) -> None:
        self.assertEqual(
            ...
            "https://github.com/anisayakmitra-in/PANDORA-AGENT/releases/download/v2.0.0-alpha.4/pandora-linux",
        )
        with self.assertRaises(ValueError):
    ...
    def test_launcher_rejects_tampered_offline_cache(self) -> None:
        ...
        try:
            ...
            artifact = cache / "v2.0.0-alpha.4" / artifact_name_for_host
            ...
            environment.update(
                {
                    ...
                    "PANDORA_VERSION": "v2.0.0-alpha.4",
                }
            )
